            ...
            <div class="row g-4">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary card-outline mb-4">
                        ...
                        <!--end::Header-->
                        <!--begin::Form-->
                        <form action="{{ url('/admin/product/create/update/' . $product->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $product->sku_code }}"
                                            name="sku_code" id="sku_code" required />
                                    </div>
                                        ...
                                        <div class="form-group" id="color_fields">
                                            ...
                                            @foreach ($product->color as $singleColor)
                                                <input type="text" class="form-control"
                                                    value="{{ $singleColor->color_name }}" name="color_name[]"
                                                    id="color_name" />
                                                <a href="{{ url('/admin/product/color/delete/' . $singleColor->id) }}"
                                                    class="btn btn-danger mt-1"> Delete </a>
                                            @endforeach
                                        </div>
                                        <button type="button" class="btn btn-primary float-end" id="add_color"> Add More
                                        </button>
                                    </div>
                                    ...
                                    <div class="col-6 mb-3">
                                        <div class="form-group" id="size_fields">
                                            ...
                                            @foreach ($product->size as $singleSize)
                                                <input type="text" class="form-control"
                                                    value="{{ $singleSize->size_name }}" name="size_name[]"
                                                    id="size_name" />
                                                <a href="{{ url('/admin/product/size/delete/' . $singleSize->id) }}"
                                                    class="btn btn-danger mt-1"> Delete </a>
                                            @endforeach
                                        </div>
                                        <button type="button" class="btn btn-primary float-end" id="add_size"> Add More
                                        </button>
                                    </div>
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="number" class="form-control" value="{{ $product->buying_price }}"
                                            name="buying_price" id="buying_price" required />
                                    </div>
                                    ...
                                    <div class="col-6 mb-3">
                                        <label for="discount_price" class="form-label">Product Discount Price (Optional)
                                        </label>
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea class="form-control" name="description" id="summernote" required> {{ $product->description }} </textarea>
                                    </div>

                                    <div class="col-12 mb-3">
                                        <label for="product_policy" class="form-label"> Product Policy (Optional) </label>
                                        <textarea class="form-control" name="product_policy" id="summernote2"> {{ $product->product_policy }} </textarea>
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <img src="{{ asset('backend/images/product/' . $product->image) }}" height="80"
                                            width="80">
                                    </div>

                                    <div class="input-group mb-3">
                                        <input type="file" class="form-control" accept="image/*"
                                            name="gallery_image[]" id="gallery_image" multiple />
                                        <label class="input-group-text" for="gallery_image">Upload Gallery Image</label>
                                        @foreach ($product->galleryImage as $singleImage)
                                            <img src="{{ asset('backend/images/galleryimage/' . $singleImage->image) }}"
                                                height="80" class="mb-2" width="80">
                                            <div class="mb-2">
                                                <a href="{{ url('/admin/product/gallery-image/delete/'.$singleImage->id)}}"
                                                    class="btn btn-danger"> Delete </a>
                                                <a href="{{ url('/admin/product/gallery-image/edit/'.$singleImage->id) }}"
