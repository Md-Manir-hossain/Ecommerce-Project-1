		...
		<section class="product-section">
			<div class="container">
				<div class="section-title-outer">
					...
					<a href="{{url ('/type-products/new arrival')}}" class="product-view-all-btn">
						View All
					</a>
				</div>
				<div class="product-items-wrapper">
					@foreach ($newArrivalProducts as $newProduct)
						...
						<div class="product__item-image-outer">
							<a href="{{url ('product-details/'.$product->slug)}}" class="product__item-image-inner">
								<img src="{{asset ('backend/images/product/'.$newProduct->image)}}" alt="Product Image" />
							</a>
							<div class="product__item-add-cart-btn-outer">
								<a href="#" class="product__item-add-cart-btn-inner">
									Add to Cart
			...
			<div class="container">
				...
				<div class="product-items-wrapper">
					...
					<div class="product__item-outer">
						<div class="product__item-image-outer">
							<a href="{{url ('product-details/'.$product->slug)}}" class="product__item-image-inner">
								<img src="{{asset ('backend/images/product/'.$regularProduct->image)}}" alt="Product Image" />
							</a>
							<div class="product__item-add-cart-btn-outer">
								<a href="#" class="product__item-add-cart-btn-inner">
									Add to Cart
			...
			<div class="container">
				...
				<div class="product-items-wrapper">
					...
					<div class="product__item-outer">
						<div class="product__item-image-outer">
							<a href="{{url ('product-details/'.$product->slug)}}" class="product__item-image-inner">
								<img src="{{asset ('backend/images/product/'.$discountProduct->image)}}" alt="Product Image" />
							</a>
							<div class="product__item-add-cart-btn-outer">
								<a href="#" class="product__item-add-cart-btn-inner">
									Add to Cart
