                                    ...
                                    <ul class="header__nav-item-category-submenu">
                                        @foreach ($category->subCategory as $subCategory)
                                            <li class="header__category-submenu-item">
                                                <a href="{{ url('/sub-category-products/' . $subCategory->slug . '/' . $subCategory->id) }}"
                ...
                <div class="categoris-items-wrapper owl-carousel">
                    @foreach ($categories as $category)
                        <a href="{{ url('/category-products/' . $category->slug . '/' . $category->id) }}" class="categoris-item">
                            ...
                            <span class="items-number">{{ App\Models\Product::where('cat_id', $category->id)->count() }}
                                items</span>
                        </a>
                    @endforeach
                </div>
            ...
            <div class="container">
                ...
                <div class="product-items-wrapper">
                    @foreach ($newArrivalProducts as $newProduct)
                        <div class="product__item-outer">
                            <div class="product__item-image-outer">
                                <a href="{{ url('product-details/'.$newProduct->slug) }}" class="product__item-image-inner">
                                    <img src="{{ asset('backend/images/product/'. $newProduct->image) }}"
                                        alt="Product Image" />
                                </a>
                                <div class="product__item-add-cart-btn-outer">
                                    <a href="{{url('add-to-cart/'.$newProduct->id)}}"
                                        class="product__item-add-cart-btn-inner">
                                        Add to Cart
                                    </a>
                                </div>
                            ...
                            <div class="product__item-info-outer">
                                <a href="{{url('product-details/'.$newProduct->slug) }}" class="product__item-name">
                                    {{$newProduct->name}}
                                </a>
                                <div class="product__item-price-outer">
                                    @if ($newProduct->discount_price != null)
                                        <div class="product__item-discount-price">
                                            <del>{{$newProduct->regular_price}} Tk.</del>
                                        </div>
                                        <div class="product__item-regular-price">
                                            <span>{{$newProduct->discount_price}} Tk.</span>
                                        </div>
                                    @else
                                        <div class="product__item-regular-price">
                                            <span>{{$newProduct->regular_price}} Tk.</span>
                                        </div>
                                    @endif
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="product-items-wrapper">
                    @foreach ($regularProducts as $regularProduct)
                        <div class="product__item-outer">
                            <div class="product__item-image-outer">
                                <a href="{{url('product-details/'.$regularProduct->slug) }}"
                                    class="product__item-image-inner">
                                    <img src="{{asset('backend/images/product/'.$regularProduct->image) }}"
                                        alt="Product Image" />
                                </a>
                                <div class="product__item-add-cart-btn-outer">
                                    <a href="{{ url('add-to-cart/'.$regularProduct->id) }}"
                                        class="product__item-add-cart-btn-inner">
                                        Add to Cart
                                    </a>
                                </div>
                            ...
                            <div class="product__item-info-outer">
                                <a href="{{url('product-details/'.$regularProduct->slug)}}" class="product__item-name">
                                    {{ $regularProduct->name }}
                                </a>
                                <div class="product__item-price-outer">
                                    @if ($product->discount_price != null)
                                        <div class="product__item-discount-price">
                                            <del>{{$regularProduct->regular_price}} Tk.</del>
                                        </div>
                                        <div class="product__item-regular-price">
                                            <span>{{$regularProduct->discount_price}} Tk.</span>
                                        </div>
                                    @else
                                        <div class="product__item-regular-price">
                                            <span>{{$regularProduct->regular_price}} Tk.</span>
                                        </div>
                                    @endif
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="product-items-wrapper">
                    @foreach ($discountProducts as $discountProduct)
                        <div class="product__item-outer">
                            <div class="product__item-image-outer">
                                <a href="{{ url('product-details/'.$discountProduct->slug) }}"
                                    class="product__item-image-inner">
                                    <img src="{{ asset('backend/images/product/' . $discountProduct->image) }}"
                                        alt="Product Image" />
                                </a>
                                <div class="product__item-add-cart-btn-outer">
                                    <a href="{{ url('add-to-cart/'.$discountProduct->id) }}"
                                        class="product__item-add-cart-btn-inner">
                                        Add to Cart
                                    </a>
                                </div>
                                <div class="product__type-badge-outer">
                                    <span class="product__type-badge-inner">
                                        {{ $discountProduct->product_type }}
                                    </span>
                                </div>
                            </div>
                            <div class="product__item-info-outer">
                                <a href="{{ url('product-details/'.$discountProduct->slug)}}" class="product__item-name">
                                    {{ $discountProduct->name }}
                                </a>
                                <div class="product__item-price-outer">
                                    @if ($product->discount_price != null)
                                        <div class="product__item-discount-price">
                                            <del>{{$discountProduct->regular_price}} Tk.</del>
                                        </div>
                                        <div class="product__item-regular-price">
                                            <span>{{$discountProduct->discount_price}} Tk.</span>
                                        </div>
                                    @else
                                        <div class="product__item-regular-price">
                                            <span>{{$discountProduct->regular_price}} Tk.</span>
                                        </div>
                                    @endif
                                </div>
                            </div>
